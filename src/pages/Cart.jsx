...
const Cart = () => {
  ...
  const onClearCart = () => {
    if (window.confirm('Do you really want to remove all pizzas?')) {
      dispatch(clearCart());
    }
  };

  const onRemoveCartItem = (id) => {
    if (window.confirm('Do you really want to remove that kind of pizzas?')) {
  ...
  const onPurchase = () => {
    console.log('YOUR PURCHASE', items);
  };
        ...
        <div className="cart">
          ...
          <div className="cart__bottom">
            ...
            <div className="cart__bottom-buttons">
              ...
              <Button onClick={onPurchase} className="pay-btn">
