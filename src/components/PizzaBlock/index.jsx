...
const PizzaBlock = ({ id, name, imageUrl, price, types, sizes, onClickAddPizza, itemsInCart }) => {
  ...
  const onAddPizza = () => {
    const obj = {
      id, name, imageUrl, price, type: availableTypes[activeType], size: activeSize
    };
    onClickAddPizza(obj);
  };
